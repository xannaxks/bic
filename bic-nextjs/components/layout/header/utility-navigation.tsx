  ...
  return (
    <div className="container flex h-14 items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        <ThemeToggle />
        <button className="bg-primary text-primary-foreground ring-offset-background hover:bg-primary/90 focus-visible:ring-ring inline-flex h-9 items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50">
          {tUtility("auth.login")}
        </button>
      </div>
    </div>
